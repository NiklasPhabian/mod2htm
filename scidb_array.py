...
class Database:
    def __init__(self):
        #self.address = "http://scidb.duckdns.org:8080"
        self.address = "http://tong.eri.ucsb.edu:8080"
...
class I2ArrayLoad(Array):
    def __init__(self, db):
        ...
        self.is_temp = True
        self.name = 'i2_load'
        self.attributes = "<ilat:int64, ilon:int64, scan_group:int8, band1:int16, band2:int16, band3:int16, band4:int16>"
...
class I2Array(Array):
    def __init__(self, db):
        ...
        self.name = 'i2'
        self.attributes = "<band1:int16, band2:int16, band3:int16, band4:int16>"
        self.dimensions = "[ilat=-900000:900000:0:50000; ilon=-1800000:1800000:0:50000; scan_group=0:203:0:203]"
